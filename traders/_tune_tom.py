...
TOMATOES_QUOTE_SIZE = 8
TOMATOES_BASE_HALF_SPREAD = 7.5
TOMATOES_MIN_EDGE = 2.5
TOMATOES_INVENTORY_SKEW_PER_UNIT = 0.09
TOMATOES_FAIR_ALPHA = 0.04
TOMATOES_TREND_WEIGHT = 0.15
TOMATOES_MAX_TREND_SHIFT = 2.5
TOMATOES_IMBALANCE_ADJUSTMENT = 1.0
TOMATOES_MAX_IMBALANCE_SHIFT = 0.4
TOMATOES_HISTORY_LENGTH = 12
TOMATOES_TAKE_EDGE = 0.5
