...
FAIR_VALUE = 10000
POSITION_LIMIT = 35
BASE_HALF_SPREAD = 5.5
MIN_EDGE = 2
QUOTE_SIZE = 13
MAX_POSITION_UTILIZATION = 1
...
TOMATOES_POSITION_LIMIT = 36
TOMATOES_QUOTE_SIZE = 12
TOMATOES_BASE_HALF_SPREAD = 11.75
TOMATOES_MIN_EDGE = 2
TOMATOES_INVENTORY_SKEW_PER_UNIT = 0.14
TOMATOES_FAIR_ALPHA = 0.2
TOMATOES_TREND_WEIGHT = 0.25
TOMATOES_MAX_TREND_SHIFT = 2.2
TOMATOES_IMBALANCE_ADJUSTMENT = 0.3
...
class Product:
    ...
    def quote_sizes(self) -> tuple[int, int]:
        usable_limit = int(self.position_limit * MAX_POSITION_UTILIZATION)
