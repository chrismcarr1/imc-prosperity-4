...
IMBALANCE_ADJUSTMENT = 7.5
MAX_IMBALANCE_SHIFT = 2
QUOTE_ADJUSTMENT = 1.5
TAKE_EDGE = .6
SECOND_LEVEL_OFFSET = 1.5
SIGNAL_SIZE_BOOST = 5
...
TOMATOES_IMBALANCE_ADJUSTMENT = .9
TOMATOES_MAX_IMBALANCE_SHIFT = 2
TOMATOES_HISTORY_LENGTH = 8
TOMATOES_TAKE_EDGE = .6
TOMATOES_SECOND_LEVEL_OFFSET = 1.1
...
class Product:
    ...
    def quote_two_levels(
        ...
        front_buy = ceil(buy_size * 0.75)
        front_sell = ceil(sell_size * 0.4)
